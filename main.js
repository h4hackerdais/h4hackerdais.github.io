...
var routes = [
    ...
    {
        path: 'task',
        component: _task_task_component__WEBPACK_IMPORTED_MODULE_10__["TaskComponent"]
    },
    {
        path: '',
...
module.exports = "<div class=\"container\">\n  <h2>Todo List</h2>\n  <div class=\"row\">\n    <div class=\"col-md-6\">\n      <ul class=\"list-unstyled\">\n        <li>\n          {{task}}\n          <form action=\"\" class=\"form-horizontal\">\n            <div class=\"form-group\">\n            <input type=\"text\" name=\"task\" class=\"form-control\" [(ngModel)]=\"task\">\n          </div>\n            <button (click)=\"addTask()\" class=\"btn btn-primary btn-block\">Add Task</button>\n          </form>\n\n        </li>\n      </ul>\n    </div>\n\n    <div class=\"col-md-6\">\n\n      <ul>\n        <li *ngFor=\"let item of TaskList; let i = index\" >{{item}}\n\n          <a href=\"javascript::\" (click)=\"removeTask(i)\">X</a>\n\n        </li>\n      </ul>\n\n      \n"
...
var TaskComponent = /** @class */ (function () {
    ...
    TaskComponent.prototype.removeTask = function (index) {
        this.TaskList.splice(index, 1);
    };
...
module.exports = __webpack_require__(/*! /home/hacker-dais/projects/angular7morning/src/main.ts */"./src/main.ts");
